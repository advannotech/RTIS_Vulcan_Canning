                ...
                if (Directory.Exists(GlobalVars.RSCFolder) == false || File.Exists(GlobalVars.SettingsDB) == false)
                {
                    ...
                    switch (created.Split('*')[0])
                    {
                        case "1":
                            ...
                            insertString += "CanningWhse|ZECT~";
                            insertString += "CanningIT|ZECT IT~";
                            insertString += "CanningPath|Select Path~";
                    ...
                    if (setting != string.Empty)
                    {
                        ...
                        switch (settingName)
                        {
                            ...
                            case "ServerPort":
                                ...
                                break;
                            case "CanningWhse":
                                GlobalVars.canningWhse = settingValue;
                                break;
                            case "CanningIT":
                                GlobalVars.canningIT = settingValue;
                                break;
                            case "CanningPath":
                                GlobalVars.canningLoc = settingValue;
                                break;
                            case "Printer":
                                GlobalVars.Printer = settingValue;
                                break;
                            case "LotLookup":
                                GlobalVars.LotLookup = settingValue;
                                break;
                        }
                    }
                }
